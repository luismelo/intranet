    ...
    static private function insertMenu() {
        ...
        if ($pageexist == 0) {
            $post = array(
                ...
                'post_title' => 'Abertura de Chamados',
                'post_status' => 'publish',
    ...
    static private function runSQL() {
        ...
        if ($runConfig == 0) {
            ...
            $query = "INSERT INTO `" . jssupportticket::$_db->prefix . "js_ticket_emailtemplates` (`id`, `templatefor`, `title`, `subject`, `body`, `created`, `status`) VALUES
        						(1, 'ticket-new', '', 'JS Tickets: Novo chamado recebido ', 'Caro {USERNAME},\r\n\r\nSeu chamado <strong>{SUBJECT}</strong> foi enviado. Tentaremos responder todos os chamados o mais rápido possivel, normalmente dentro de 24 horas.\r\n\r\nSeu ID: {TRACKINGID}\r\n\r\nSeu Email ID: {EMAIL}\r\n\r\nMensagem: {MESSAGE}\r\n\r\nVocê pode verificar o status do seu ticket aqui:\r\n{TICKETURL}\r\n\r\nVocê irá receber uma mensagem de email quando a nossa equipe responder ao seu chamado.\r\n\r\n<span style=\"color: red;\"><strong>*NÃO RESPONDA ESSE EMAIL*</strong></span>\r\nEssa é uma mensagem automática e que não terá retorno caso seja respondida', NULL, 0),
        						(2, 'department-new', '', 'JS Tickets :  Novo departamento {DEPARTMENT_TITLE} foi recebido ', 'Olá admin ,\r\n\r\nRecebemos esse novo departamento.\r\n\r\n<span style=\"color: red;\"><strong>*DO NOT REPLY TO THIS E-MAIL*</strong></span>\r\nThis is an automated e-mail message sent from our support system. Do not reply to this e-mail as we wonot receive your reply!', NULL, 0),
