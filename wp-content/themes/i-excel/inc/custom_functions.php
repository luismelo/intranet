...
function iexcel_social_icons () {
	...
	$services = array ('facebook','twitter','flickr','feed','instagram','googleplus','youtube');
...
function iexcel_ibanner_slider () {    
    ...
    for( $slideno=1; $slideno<=4; $slideno++ ){
			...
			$slide_linkurl = esc_url(get_theme_mod('itrans_slide'.$slideno.'_linkurl', 'https://wordpress.org/'));
