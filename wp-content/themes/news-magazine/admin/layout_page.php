				...
				<tbody>
					...
					<tr>
						<td style="font-size:14px; font-weight:bold; padding-left: 5px;">
							<a href="<?php echo $news_magazine_web_dor.'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">User Manual</a><br />This section allows you to make changes in the layout of the theme.  
