	...
	public function exclusive_install_posts(){
		...
		<div id="main_install_page">
			<table align="center" width="90%" style="margin-top: 0px;">
				<tr>
					<td>
						<h2 style="margin:15px 0px 0px;font-family:Segoe UI;padding-bottom: 10px;color: rgb(111, 111, 111); font-size:28pt;">Install <?php echo __("Sample Data","wd_exclusive"); ?></h2>
					</td>
				</tr>
				<tr>   
			...
			<div id="install_remove">
			    <p style="font-size:15px;font-weight:bold;color: #333;padding: 12px 11px 0;"><?php echo __("To get an overall impression of the theme and to get acquainted with its main capabilities we suggest you to install sample data.","wd_exclusive"); ?></p>
